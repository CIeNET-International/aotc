...
from aotc.benchmark_db_writer.schema.workload_benchmark_v2 import storage_info_schema

_STORAGE_PRODUCT = flags.DEFINE_string(
    "storage_product", "", "Type of the storage product.")
_CONFIG = flags.DEFINE_string(
    "config", '', "The configs of the storage system.")
_DESCRIPTION = flags.DEFINE_string(
    "description", "", "The description of the storage system.")
_IS_TEST = flags.DEFINE_bool(
    "is_test", False, "True to write the storage info to the test project.")
...
def write_storage_config(project, dataset, table, dataclass_type,
                         storage_product, config, description
                         ):
