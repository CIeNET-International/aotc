...
def write_software_config(project, dataset, table, dataclass_type,
                          software_id, ml_framework, os, compiler,
                          training_framework,
  ...
  if software_info:
    raise ValueError("Software id %s is already present in the %s "
                     "table" % (software_id, table))
