...
from benchmark_db_writer.schema.supplemental_metrics import listing_metrics_schema
...
def main(_: Sequence[str]):
  write_listing_metrics(
      project=(
          ...
          if common_flags.IS_TEST.value
          else "ml-workload-benchmarks"
      ),
      dataset=(
          "mantaray_v2"
          if common_flags.IS_TEST.value
          else "benchmark_dataset_v2"
      ),
