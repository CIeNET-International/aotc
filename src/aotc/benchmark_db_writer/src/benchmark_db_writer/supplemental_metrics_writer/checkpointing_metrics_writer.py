...
_RESTORE_TIME_P50 = flags.DEFINE_float(
    "restore_time_p50",
    None,
    "50 percentile of the time it takes to restore a checkpoint from storage,"
    " in seconds.",
)
_RESTORE_TIME_P90 = flags.DEFINE_float(
    "restore_time_p90",
    None,
    "90 percentile of the time it takes to restore a checkpoint from storage,"
    " in seconds.",
)
_RESTORE_TIME_P99 = flags.DEFINE_float(
    "restore_time_p99",
    None,
    "99 percentile of the time it takes to restore a checkpoint from storage,"
    " in seconds.",
)
_RESTORE_TIME_P100 = flags.DEFINE_float(
    "restore_time_p100",
    None,
    "100 percentile of the time it takes to restore a checkpoint from storage,"
    " in seconds.",
)
...
_RESTORE_TIME_AVG = flags.DEFINE_float(
    "restore_time_avg",
    None,
    "The average time it takes to restore a checkpoint from storage,"
    " in seconds.",
)
...
_WRITE_TIME_P50 = flags.DEFINE_float(
    "write_time_p50",
    None,
    "50 percentile of the time it takes to write a checkpoint to storage, in"
    " seconds.",
)
_WRITE_TIME_P90 = flags.DEFINE_float(
    "write_time_p90",
    None,
    "90 percentile of the time it takes to write a checkpoint to storage, in"
    " seconds.",
)
_WRITE_TIME_P99 = flags.DEFINE_float(
    "write_time_p99",
    None,
    "99 percentile of the time it takes to write a checkpoint to storage, in"
    " seconds.",
)
_WRITE_TIME_P100 = flags.DEFINE_float(
    "write_time_p100",
    None,
    "100 percentile of the time it takes to write a checkpoint to storage, in"
    " seconds.",
)
...
_ACCELERATOR_TO_CPU_TIME_MAX = flags.DEFINE_float(
    ...
    None,
    "The max time it takes to transfer a checkpoint from GPU to CPU memory,"
    " in seconds.",
)
_ACCELERATOR_TO_CPU_TIME_MIN = flags.DEFINE_float(
    "accelerator_to_cpu_time_min",
    None,
    "The min time it takes to transfer a checkpoint from GPU to CPU memory,"
    " in seconds.",
)
_ACCELERATOR_TO_CPU_TIME_AVG = flags.DEFINE_float(
    "accelerator_to_cpu_time_avg",
    None,
    "The average time it takes to transfer a checkpoint from GPU to CPU memory,"
    " in seconds.",
)
_STORAGE_SAVE_TIME_MAX = flags.DEFINE_float(
    "storage_save_time_max",
    None,
    "The max time it takes to write a checkpoint from CPU memory to storage,"
    " in seconds.",
)
_STORAGE_SAVE_TIME_MIN = flags.DEFINE_float(
    "storage_save_time_min",
    None,
    "The min time it takes to write a checkpoint from CPU memory to storage,"
    " in seconds.",
)
_STORAGE_SAVE_TIME_AVG = flags.DEFINE_float(
    "storage_save_time_avg",
    None,
    "The average time it takes to write a checkpoint from CPU memory to"
    " storage, in seconds.",
)
_NUM_RESTORE_DATAPOINTS = flags.DEFINE_integer(
    "num_restore_datapoints", None, "The number of the restore datapoints."
)
_NUM_WRITE_DATAPOINTS = flags.DEFINE_integer(
    "num_write_datapoints", None, "The number of the write datapoints."
)
...
def write_checkpointing_metrics(
  ...
  if bq_writer_utils.validate_id(
    ...
    checkpointing_metrics_data = (
        checkpointing_metrics_schema.CheckpointingMetricsInfo(
            run_id=run_id,
    ...
    logging.info(
        "Writing Data %s to %s table.", checkpointing_metrics_data, table
    )
